...
//  довільний рядок, який записується у приватну властивість value обєкта, що створюється.

// Оголоси наступні методи класу:

// getValue() — повертає поточне значення приватної властивості value.
//     padEnd(str) — отримує параметр str(рядок) і додає його в кінець
//  значення приватної властивості value обєкта, який викликає цей метод.
...
// в кінець значення приватної властивості value обєкта, який викликає цей метод.
