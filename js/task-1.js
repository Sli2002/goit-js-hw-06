...
// Виконай рефакторинг методів обєкта customer, розставивши відсутні
// this під час звернення до властивостей обєкта.
// Використай цей стартовий код і виконай рефакторинг.
//  Після оголошення обєкта ми додали виклики методів.
...
// Виклик customer.addOrder(5000, "Steak") додає "Steak" у масив значень властивості
//  orders та оновлює баланс
